...
\usepackage{algorithmic}    % Provides algorithmic environment for pseudocode
% OR alternatively, use algorithmicx (more modern):
...
\title{FedQHD: Closed-Form Function-Space Federated Reinforcement Learning}
%\title{FedQHD}
...
\setrunningtitle{FedQHD: Closed-Form Function-Space Federated Reinforcement Learning}
%\setrunningtitle{FedQHD}
